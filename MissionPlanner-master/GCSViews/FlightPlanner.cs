...
Column 1: Field type (RALLY is the only one at the moment -- may have RALLY_LAND in the future)
 ...
 Column 7: Flags (just 0 for now, also future use).
        ...
        {
            //PradoAirTest Flight Test by Patrick
            //------------------------------------
        ...
        {
            //RunWaypointCode by Patrick
            //Runs Search Grid Code then Runs Obstacle Avoidance Code
            //------------------------------------
            ProcessStartInfo searchgrid_startinfo = new ProcessStartInfo();
